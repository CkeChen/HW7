<%@ Page Title="" Language="VB" MasterPageFile="~/Games.master" AutoEventWireup="false" CodeFile="ViewAllGames.aspx.vb" Inherits="admin_ViewAllGames" %>
    ...
    <div>
        ...
        <asp:GridView ID="GridView1" runat="server" AllowSorting="True" AutoGenerateColumns="False" DataKeyNames="Game_ID" DataSourceID="SqlDataSource1">
            <Columns>
                ...
                <asp:HyperLinkField DataNavigateUrlFields="Game_ID" DataNavigateUrlFormatString="~/admin/GameDetail.aspx?Game_ID={0}" Text="ViewDetail" />
            </Columns>
        </asp:GridView>
</asp:Content>
